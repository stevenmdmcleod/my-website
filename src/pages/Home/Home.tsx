            ...
            */}
            ...
            <div className="car-container">
                ...
                <div className="car-forward">
                    <img src="/assets/flyingcar-1.png" alt="" className="car" id="car1" />
                </div>

                <div className="car-backward">
                <img src="/assets/flyingcar-1.png" alt="" className="car" id="car2"/>
                </div>

                <div className="car-forward">
                <img src="/assets/flyingcar-1.png" alt="" className="car" id="car3"/>
                </div>

                <div className="car-backward">
                <img src="/assets/flyingcar-1.png" alt="" className="car" id="car4"/>
                </div>

                <div className="car-forward">
                <img src="/assets/flyingcar-1.png" alt="" className="car" id="car5"/>
                </div>
